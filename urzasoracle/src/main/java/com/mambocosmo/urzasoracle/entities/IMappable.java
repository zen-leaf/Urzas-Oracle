            ...
            if (k != null) {
                try {
                    ...
                    if (in.containsKey(k) && m.getParameterTypes().length == 1) {
                        ...
                        Object param = null;
                        String objectProxy = String.valueOf(in.get(k));

                        switch (methodType.getSimpleName()) {
                                ...
                                case "BigInteger":
                                    Long paramProxyBI = Long.valueOf(objectProxy);
                                    param = BigInteger.valueOf(paramProxyBI);
                                    break;
                                ...
                                case "Byte[]":
                                    String[] inString = objectProxy.replaceAll("\\s","").split(",");
                        ...
                        // System.out.println("Invoking " + m + " with " + param + " arg");
