...
public class CardInDeckConverter {
    ...
    public CardInDeckDTO fromEToD(CardInDeck entity) {
        ...
        String backimgurl = null;
        if (entity.getId().getCard().getImage_uris() != null) {
            // backimgurl = entity.getId().getCard().getImage_uris().get("normal");
            backimgurl = dto.getRefCard().getBackFace().getImages().get("normal");
        }
        dto.setBackImageUrl(backimgurl);
        String imageUrl = null;
        if (entity.getId().getCard().getImage_uris() != null) {
            // imageUrl = entity.getId().getCard().getImage_uris().get("normal");
            imageUrl = dto.getRefCard().getImages().get("normal");
